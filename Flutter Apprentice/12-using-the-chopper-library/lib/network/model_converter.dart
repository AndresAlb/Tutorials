// Built-in Dart convert package transforms data to & from JSON
import 'dart:convert';
...
{
  // Override convertRequest(), which takes in a request and
  ...
  // Whenever you make network calls, you want to ensure that you encode the
  // request before you send it and decode the response string into your
  // model classes, which you’ll use to display data in the UI. The functions
  // defined below will do that
  ...
  Response<BodyType> decodeJson<BodyType, InnerType>(Response response)
  {
    ...
    // Check that you’re dealing with JSON and decode the response
    ...
    try
    {
      ...
      // Here, you check to see if the map contains such a field. If so,
      // you return a response that embeds an instance of Error
    ...
    {
      // If you get any other kind of error, wrap the response with a
      // generic instance of Error
  ...
  {
    // Simply calls decodeJson which is written above
