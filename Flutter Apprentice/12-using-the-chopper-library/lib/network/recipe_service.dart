...
// have the same name as this file, but with .chopper added to it. In this
// case, it will be recipe_service.chopper.dart.
// Such a file will hold the boilerplate code
@ChopperApi()

// RecipeService is an abstract class because you only need to define the
// method signatures. The generator script will take these definitions
// and generate all the code needed
abstract class RecipeService extends ChopperService
{
  // @Get is an annotation that tells the generator this is a GET request with
  // a path named search. There are other HTTP methods you can use, such as
  // @Post, @Put and @Delete, but you won’t use them in this chapter
  @Get(path: 'search')
  ...
  static RecipeService create()
  {
    ...
    final client = ChopperClient(
      ...
      // It’s handy while you’re developing to see traffic between the app
      // and the server
...
{
  // Creates a Map, which contains key-value pairs from the existing
  // Request parameters
