...
class _MyRecipesListState extends State<MyRecipesList>
{
  ...
  {
    // This creates a Consumer of a MemoryRepository, which receives the
    // repository. Remember that Consumer is a widget that can receive a
    // class from a parent Provider
  ...
  void deleteRecipe(MemoryRepository repository, Recipe recipe) async
  {
    if (recipe.id != null)
    {
      ...
      // Use setState() to redraw the view
      setState(() {});
    }
    else
    {
